...
config.bind('S', 'search-prev')
# config.bind('O', 'set-cmd-text -s :open -t')
config.bind('YY', 'open -t -- {primary}')
config.bind('Yy', 'open -t -- {clipboard}')
# config.bind('R', 'reload -f')
config.bind('Eb', 'bookmark-list --jump')
config.bind('Eh', 'history')
config.bind('Eq', 'bookmark-list')
config.bind('Es', 'set')
config.bind('C', 'set-cmd-text -sr :tab-focus')
...
config.bind('t', 'scroll right')
# config.bind('m', 'quickmark-save')
config.bind('s', 'search-next')
# config.bind('o', 'set-cmd-text -s :open')
config.bind('yY', 'open -- {primary}')
config.bind('yy', 'open -- {clipboard}')
# config.bind('q', 'macro-record')
# config.bind('r', 'reload')
config.bind('ef', 'save')
config.bind('ek', 'set-cmd-text -s :bind')
config.bind('el', 'set-cmd-text -s :set -t')
config.bind('es', 'set-cmd-text -s :set')
config.bind('\'CH', 'config-cycle -p -u *://*.{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('\'Ch', 'config-cycle -p -u *://{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('\'Cu', 'config-cycle -p -u {url} content.cookies.accept all no-3rdparty never ;; reload')
config.bind('\'IH', 'config-cycle -p -u *://*.{url:host}/* content.images ;; reload')
config.bind('\'Ih', 'config-cycle -p -u *://{url:host}/* content.images ;; reload')
config.bind('\'Iu', 'config-cycle -p -u {url} content.images ;; reload')
config.bind('\'PH', 'config-cycle -p -u *://*.{url:host}/* content.plugins ;; reload')
config.bind('\'Ph', 'config-cycle -p -u *://{url:host}/* content.plugins ;; reload')
config.bind('\'Pu', 'config-cycle -p -u {url} content.plugins ;; reload')
config.bind('\'SH', 'config-cycle -p -u *://*.{url:host}/* content.javascript.enabled ;; reload')
config.bind('\'Sh', 'config-cycle -p -u *://{url:host}/* content.javascript.enabled ;; reload')
config.bind('\'Su', 'config-cycle -p -u {url} content.javascript.enabled ;; reload')
config.bind('\'cH', 'config-cycle -p -t -u *://*.{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('\'ch', 'config-cycle -p -t -u *://{url:host}/* content.cookies.accept all no-3rdparty never ;; reload')
config.bind('\'cu', 'config-cycle -p -t -u {url} content.cookies.accept all no-3rdparty never ;; reload')
config.bind('\'h', 'back -t')
config.bind('\'iH', 'config-cycle -p -t -u *://*.{url:host}/* content.images ;; reload')
config.bind('\'ih', 'config-cycle -p -t -u *://{url:host}/* content.images ;; reload')
config.bind('\'iu', 'config-cycle -p -t -u {url} content.images ;; reload')
config.bind('\'l', 'forward -t')
config.bind('\'pH', 'config-cycle -p -t -u *://*.{url:host}/* content.plugins ;; reload')
config.bind('\'ph', 'config-cycle -p -t -u *://{url:host}/* content.plugins ;; reload')
config.bind('\'pu', 'config-cycle -p -t -u {url} content.plugins ;; reload')
config.bind('\'sH', 'config-cycle -p -t -u *://*.{url:host}/* content.javascript.enabled ;; reload')
config.bind('\'sh', 'config-cycle -p -t -u *://{url:host}/* content.javascript.enabled ;; reload')
config.bind('\'su', 'config-cycle -p -t -u {url} content.javascript.enabled ;; reload')
# config.bind('u', 'undo')
...
config.bind('xD', 'yank domain -s')
config.bind('xM', 'yank inline [{title}]({url}) -s')
config.bind('xP', 'yank pretty-url -s')
config.bind('xT', 'yank title -s')
config.bind('xY', 'yank -s')
config.bind('xd', 'yank domain')
config.bind('xm', 'yank inline [{title}]({url})')
config.bind('xp', 'yank pretty-url')
config.bind('xt', 'yank title')
config.bind('xx', 'yank')
...
config.bind('>b', 'move-to-end-of-document', mode='caret')
config.bind('H', 'scroll left', mode='caret')
config.bind('N', 'scroll down', mode='caret')
config.bind('P', 'scroll up', mode='caret')
config.bind('T', 'scroll right', mode='caret')
# config.bind('V', 'selection-toggle --line', mode='caret')
config.bind('X', 'yank selection -s', mode='caret')
...
config.bind('p', 'move-to-prev-line', mode='caret')
config.bind('t', 'move-to-next-char', mode='caret')
# config.bind('o', 'selection-reverse', mode='caret')
# config.bind('v', 'selection-toggle', mode='caret')
# config.bind('w', 'move-to-next-word', mode='caret')
config.bind('x', 'yank selection', mode='caret')
